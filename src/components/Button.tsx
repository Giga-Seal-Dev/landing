	...
	return (
		<div className='relative group'>
			<a href={link} className='inline-block'>
				<button
					className={`rounded-full px-6 py-2 font-semibold text-lg transition-all duration-300  hover:scale-105 text-${headerTextColor} 
			  ${
					type === 'colorful'
						...
						${
							isHeader
								? `text-${headerTextColor} border-${headerTextColor}`
								: 'text-white'
						}`
