...
export default function MainSection() {
	return (
		<section className=' text-white mt-9 bg-neutral-500 px-12 flex justify-center'>
			<div className='flex flex-col md:flex-row md:container min-mobile:px-10 items-center self-center justify-between md:h-screen min-mobile:py-32'>
				<div className='flex flex-col w-full md:w-1/2 '>
					...
					<h2 className='text-3	xl mb-7 italic'>«Scientia potentia est»</h2>
					...
					<button className='text-4xl border border-solid hover:bg-black'>
						Кнокпа
					</button>
				</div>
